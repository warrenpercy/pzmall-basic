 ...
 */
public class QueryMallLogistics extends PaginateBaseDO {
    private Long id;
    ...
    private String logisticsNameLike;
    ...
    public String getLogisticsNameLike() {
        return logisticsNameLike;
    }

    public void setLogisticsNameLike(String logisticsNameLike) {
        this.logisticsNameLike = logisticsNameLike;
    }
}
