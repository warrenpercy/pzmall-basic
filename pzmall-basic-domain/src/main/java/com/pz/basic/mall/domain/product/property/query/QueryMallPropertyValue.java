 ...
 * @date 2020/9/2 9:24
 */
public class QueryMallPropertyValue extends PaginateBaseDO {
    ...
    private String valueDataLike;

    public String getValueDataLike() {
        return valueDataLike;
    }

    public void setValueDataLike(String valueDataLike) {
        this.valueDataLike = valueDataLike;
    }
